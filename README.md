...
- `content`: add or revise book prose, examples, or exercises
...
```text
content: add preliminary book chapter
build: configure Quarto book output
fix: correct Python environment instructions
```
